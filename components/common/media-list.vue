<template>
	<view style="width: 100%;" class="flex align-center py-2 border-bottom" @click='open'>
		<!-- <image src="/static/demo/list2/1.jpg" style="width: 260rpx;height: 160rpx;" class="rouned-lg mx-2 flex-shrink"></image> -->
		<image :src="item.cover" style="width: 260rpx;height: 160rpx;" class="rounded-lg mx-2 flex-shrink"></image>
		<view class="flex-1 flex flex-column mr-2">
			...
			<view class="flex align-center justify-between text-muted line-h">
				...
				<view class="line-h">
					<text class="iconfont icondanmushu font-md m-1"></text>
