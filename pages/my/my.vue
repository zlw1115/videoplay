<template>
	<view>
		...
		<f-list-item icon="iconshipin" title="我的作品" :showRightIcon="false" :rightText="videoCount+'个'" @click="navigateTo('user-video')"></f-list-item>
		<f-list-item icon="iconshoucang1" title="收藏" @click="navigateTo('user-fava')"></f-list-item>
		<f-list-item icon="iconguanzhu" title="关注" :rightText="followCount+'个'"  @click="navigateTo('user-follow')"></f-list-item>
			...
			<view class="position-absolute bottom-0 left-0 right-0 bg-white animated faster fadeIn ">
				<view class="flex" style="height: 200rpx;">
					...
					<view class="flex-1 flex align-center justify-center flex-column" hover-class="bg-light" @click="navigateTo('create')">
						<text class="iconfont icondingdanwenjian flex align-center justify-center text-white bg-primary rounded-circle"
						 style="height: 80rpx; width: 80rpx;"></text>
						<text class="font mt-1 text-muted">单集</text>
					</view>

					<view class="flex-1 flex align-center justify-center flex-column" hover-class="bg-light" @click="navigateTo('create')">
						<text class="iconfont icon918caidan_wenjian flex align-center justify-center text-white bg-main rounded-circle"
						 style="height: 80rpx; width: 80rpx;"></text>
				...
				<view class="f-divider"></view>
				<view class="py-2 flex justify-center align-center font-md text-muted" hover-class="bg-light" @click.stop="hidePop">取消</view>
			</view>
