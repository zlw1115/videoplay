<template>
	<view>
		<view style="height: 350rpx;" class="bg-light position-relative" hover-class="bg-hover-light" @tap="upload">
			...
			<view class="position-absolute left-0 right-0 top-0 bottom-0 flex flex-column align-center justify-center" style="background-color:rgba(255,255,255,0.3) ;">
		...
		<picker mode="selector" :range="range" @change="change">
			...
			<form-item label="分类" rightIcon>
				<input type="text" v-model="categoryTitle" placeholder="请填写视频标题" placeholder-class="text-light-muted" class="w-100 pr-5"
				 disabled="" />
			</form-item>

		</picker>
		<form-item label="描述">
			<textarea v-model="form.desc" placeholder="请填写视频描述" class="py-3" style="width:550rpx" />
			</form-item>
